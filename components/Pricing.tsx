...
const SkeletonPlanCard = () => (
  <div className="rounded-3xl p-8 ring-1 ring-gray-200 dark:ring-gray-700 animate-pulse xl:p-10">
    <div className="h-6 bg-gray-200 dark:bg-gray-700 rounded w-1/3"></div>
    <div className="mt-4 h-4 bg-gray-200 dark:bg-gray-700 rounded w-3/4"></div>
    <div className="mt-6 h-10 bg-gray-200 dark:bg-gray-700 rounded w-1/2"></div>
    <div className="mt-6 h-8 bg-gray-200 dark:bg-gray-700 rounded-md w-full"></div>
...
export const Pricing: React.FC<PricingProps> = ({ plans, onSubscribe, isEmbedded = false, isLoading = false }) => {
  const isLoadingPlans = !plans || plans.length === 0;
            ...
            plans.map((plan) => (
              <div
                ...
                className={`rounded-3xl p-8 ring-1 xl:p-10 transition-all duration-300 ${
                  plan.featured 
                  ? 'bg-gray-900 dark:bg-violet-900/30 ring-gray-900 dark:ring-violet-500 scale-105' 
              ...
              >
                ...
                >
                  {isLoading && plan.id !== 'free' ? (
                    <svg className="animate-spin h-5 w-5 mx-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24">
